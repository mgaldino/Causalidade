...
```{r McCay-test, echo=FALSE, out.width="100%", fig.cap="Figura clássica do teste de manipulação em McCrary (2008).", fig.alt="Histograma e densidades laterais indicando possível descontinuidade na densidade da running variable."}
