...
kable(pib_shares, caption = "(\\#tab:pib-shares) Parcelas de emprego por setor (shares)",
      col.names = c("Estado", "Agropecuária", "Indústria", "Serviços"))

kable(pib_prod, caption = "(\\#tab:pib-prod) PIB per capita setorial (R$ mil por trabalhador)",
      col.names = c("Estado", "Agropecuária", "Indústria", "Serviços"))
```
