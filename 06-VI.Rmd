...
3. A variável instrumental $Z$ não compartilha causa comum com $y$, incluindo, portanto, não ser descendente de $T$ (quando $T$ causa $Y$). **Causa comum**.
...
Remark 3: A literatura econométrica não costuma deixar muito claso a condição 3, falando apenas que $Z$ deve causar $T$, o que exclui essa possibilidade de causa comum existir. Porém, vejam o DAG abaixo, em que $Z$ causa $T$, como esperado, mas ainda assim a suposição de causa comum é violada.
