...
Nós sabemos que diferença simples de média identifica o ATE da segunda equação: $\hat{\gamma} = \bar{D}_{\{Z=1\}} - \bar{D}_{\{Z=0\}} = \frac{\sum_{i} z_i D_i}{\sum_{i} z_i} - \frac{\sum_{i} (1-z_i) D_i}{\sum_{i} (1-z_i)}$.
...
- Suposição chave: homocedasticidade!
