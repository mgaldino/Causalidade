...
Suposição de identificação testável: teste com múltiplos instrumentos
...
Estimando: Fuzzy: LATE. Sharp: ATE local? Mesma coisa que LATE?
...
Questões de estimação: Reportar correção de viés de Cataneo para bandas automáticas.
...
Questões de estimação: Erro padrão e p-valor com randomization test. 
