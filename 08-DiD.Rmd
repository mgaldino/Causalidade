...
**Regra prática:** sempre que possível, use a abordagem 1, enriquecendo o modelo de $Y(0)$ com estimação apenas nos não-tratados, ou a abordagem 2, PT condicional com covariáveis baseline e doubly-robust. Evite adicionar covariáveis variantes no tempo diretamente ao TWFE.
